...
class Config:
   def __init__(self, config: dict):
      ...
      self.paths_to_backup = [self._map_path_to_backup(path_to_backup) for path_to_backup in config["pathsToBackup"]]
   ...
   def __str__(self):
      return f"Config(project_name={self.project_name}, paths_to_backup={[str(p) for p in self.paths_to_backup]}, g_drive_destination_path={self.g_drive_destination_path})"
